...
namespace MeetingAppCore.Repository
{
    public class MeetingRepository : IMeetingRepository
    {
        ...
        public MeetingRepository(DbDataContext context, IMapper mapper)
        {
        ...
        public async Task<Meeting> GetMeetingByIdSignalr(int roomId)
        {
            //Console.WriteLine("4.         " + new String('~', 50));
        ...
        public void AddMeeting(Meeting room)
        {
            //Console.WriteLine("4.         " + new String('~', 50));
